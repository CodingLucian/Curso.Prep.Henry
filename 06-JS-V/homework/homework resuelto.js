...
// ---------------------------------------------------------------------------//
  ...
  //Debe tener un método llamado "detalle" que nos devuelve un objeto con las propiedades de la persona y sus 
  //valores.
  //Ej: { 
    //   Nombre: 'Juan',
    //   Apellido: 'Perez',
...
function crearInstanciaPersona(nombre, apellido, edad, dir) {
  ...
  var alguien = new Persona(nombre, apellido, edad, dir);
  return alguien;
}
...
function agregarMetodo() {
  ...
  //Ej: "Juan, 22 años"
  Persona.prototype.datos = function(n,e){
